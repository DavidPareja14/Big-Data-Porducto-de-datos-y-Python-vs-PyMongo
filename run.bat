...
echo Archivo: Delito_Violencia_Intrafamiliar.csv
...
echo Los campos con los que se trabajaran son: DEPARTAMENTO,MUNICIPIO,DIA,BARRIO,ZONA,EDAD,SEXO,ESTADOCIVIL,ESCOLARIDAD
...
echo Con que campos desea trabajar (numero de indice, desde 0 y se cuenta segun los campos de antes, para ejemplificar, solo elegir 0,1): 
...
echo Con los campos que se trabajara en Mongo son: DEPARTAMENTO,MUNICIPIO 
REM necesito los campos DEPARTAMENTO,MUNICIPIO
set campoATrabajarMongo=DEPARTAMENTO,MUNICIPIO
REM numero de veces que cada particion se va a procesar, el numero de ITERACIONES es muy importante, ya que permite que cada archivo
REM que que queda partido del archivo principal, se va a ejecutar este número de veces, esto es para que con cada iteración se obtenga
REM un tiempo, a la siguiente se obtenga otro y así sucesivamente, al final, simplemente saco el promedio. Es para que sea más "justo"
